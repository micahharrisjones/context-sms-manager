    ...
    <>
      ...
      <CardContent className="space-y-4">
        ...
        {previewUrl && !isLoadingOg && (!ogData || !ogData.title) && (
          <div className="w-full">
            {isPinterestUrl ? (
              <div className="border border-red-200 rounded-lg overflow-hidden bg-gradient-to-br from-red-50 to-pink-50 hover:shadow-md transition-shadow">
                <a 
                  href={previewUrl} 
                  target="_blank" 
                  rel="noopener noreferrer"
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-sm font-bold text-red-700 bg-red-100 px-3 py-1 rounded-full uppercase tracking-wide">PINTEREST</span>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <ExternalLink className="w-4 h-4 text-red-500 flex-shrink-0 mt-0.5" />
                  </div>
                </a>
              </div>
            ) : (
