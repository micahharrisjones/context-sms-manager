  ...
  return (
    <>
      ...
      <CardContent className="space-y-4">
        ...
        {pinterestId && (
          <div className="w-full">
            <div className="aspect-[4/5] w-full rounded-md border overflow-hidden bg-gray-50">
              <iframe
                ...
                scrolling="no"
                onError={(e) => {
                  // Fallback: show Pinterest link if iframe fails
                  const container = e.currentTarget.parentElement;
                  if (container) {
                    container.innerHTML = `
                      <div class="flex items-center justify-center h-full">
                        <a href="https://pinterest.com/pin/${pinterestId}" 
                           target="_blank" 
                           rel="noopener noreferrer"
