...
### Recent Changes
- **Integrated Microlink.io for robust link previews**: Added Microlink.io API as primary link preview service to bypass bot protection on e-commerce and protected sites. Flow: cache check → Microlink API (primary) → direct fetch fallback (OG tags/JSON-LD/oEmbed). Requires MICROLINK_API_KEY environment variable (October 2025)
